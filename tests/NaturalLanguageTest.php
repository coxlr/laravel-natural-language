...
namespace Coxlr\NaturalLanguage\Tests;

use Coxlr\NaturalLanguage\NaturalLanguage;
use Coxlr\NaturalLanguage\NaturalLanguageClient;
use Coxlr\NaturalLanguage\Verdict;
